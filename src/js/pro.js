...
(function(ns) {
  ...
  function registerConstant(constantName, constant) {
    ...
    Registry.constants[constantName] = constant
  }
  ...
  function registerSymbol(symbolName, symbolDescription) {
    ...
    const s = Registry.symbols[symbolName] = Symbol.for(symbolDescription)
    Registry.symbols[symbolName] = s
    return s
  }
  ...
  Registry.register = function(name, value) {
    ...
    switch (getType(name, value)) {
      ...
      case 'constant':
        ...
        break
      case 'symbol':
        result = registerSymbol(name, value)
        break
      case 'error':
